typedef struct FlStyleApi {
  ...
  void (*set_color)(struct FlInternalData *priv, FlStyleColor color,
                    FlColor value);
  void (*set_color_u32)(struct FlInternalData *priv, FlStyleColor color,
                        uint32_t value);
  void (*push_color_u32)(struct FlInternalData *priv, FlStyleColor color,
                         uint32_t value);
  void (*push_color)(struct FlInternalData *priv, FlStyleColor color,
                     FlColor value);
  void (*pop_color)(struct FlInternalData *priv);
  void (*push_single)(struct FlInternalData *priv, FlStyleSingle style,
                      float value);
  void (*push_vec2)(struct FlInternalData *priv, FlStyleVec2 style,
                    FlVec2 value);
...
#ifdef FLOWI_STATIC
void fl_style_set_color_impl(struct FlInternalData *priv, FlStyleColor color,
                             FlColor value);
void fl_style_set_color_u32_impl(struct FlInternalData *priv,
                                 FlStyleColor color, uint32_t value);
void fl_style_push_color_u32_impl(struct FlInternalData *priv,
                                  FlStyleColor color, uint32_t value);
void fl_style_push_color_impl(struct FlInternalData *priv, FlStyleColor color,
                              FlColor value);
void fl_style_pop_color_impl(struct FlInternalData *priv);
void fl_style_push_single_impl(struct FlInternalData *priv, FlStyleSingle style,
                               float value);
void fl_style_push_vec2_impl(struct FlInternalData *priv, FlStyleVec2 style,
                             FlVec2 value);
