...
typedef enum FlFocusedFlags {
    ...
    FlFocusedFlags_RootAndChildWindows = FlFocusedFlags_RootWindow | FlFocusedFlags_ChildWindows,
} FlFocusedFlags;
...
typedef enum FlHoveredFlags {
    ...
    FlHoveredFlags_RectOnly = FlHoveredFlags_AllowWhenBlockedByPopup | FlHoveredFlags_AllowWhenBlockedByActiveItem |
                              FlHoveredFlags_AllowWhenOverlapped,

    FlHoveredFlags_RootAndChildWindows = FlHoveredFlags_RootWindow | FlHoveredFlags_ChildWindows,
    // Hovering delays (for tooltips)// Return true after io.HoverDelayNormal elapsed (~0.30 sec)
