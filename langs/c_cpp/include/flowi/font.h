...
static FlFont fl_font_load_with_range(const char* filename, uint32_t font_size, uint16_t glyph_range_start,
...
static FlFont fl_font_load_from_memory(const char* name, uint8_t* data, uint32_t data_size, uint32_t font_size);
