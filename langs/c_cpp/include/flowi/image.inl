...
// image from memory. Supported formats are: JPEG baseline & progressive (12
// bpc/arithmetic not supported, same as stock IJG lib) PNG
// 1/2/4/8/16-bit-per-channel TGA BMP non-1bpp, non-RLE PSD (composited view
// only, no extra channels, 8/16 bit-per-channel) GIF HDR (radiance rgbE format)
// PIC (Softimage PIC)
